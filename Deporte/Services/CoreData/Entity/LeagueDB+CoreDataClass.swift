...
public class LeagueDB: NSManagedObject , Decodable{
    ...
    required convenience public init(from decoder : Decoder) throws{
        guard let entity = NSEntityDescription.entity(forEntityName: "LeagueDB", in: CoreDataServices.managedContext) else {
            fatalError("FAILED TO DECODE League CLASS")
        }
        self.init(entity : entity, insertInto: CoreDataServices.managedContext)
